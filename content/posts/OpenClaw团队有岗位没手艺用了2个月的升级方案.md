...
- [如何给 AI 建立一个灵魂](/posts/如何给ai建立一个灵魂/) — 一切的起点：4个文件搭出AI的三观、性格、记忆和关系
- [结构化输出：省掉70%的人工整理时间](/posts/结构化输出省70后处理时间/) — Agent之间怎么高效传数据？用JSON替代自然语言
- [我让 AI「审判」了上个月的账单](/posts/我让ai审判了上个月的账单/) — AI不只能干正经活，还能用毒舌帮你改掉坏习惯

...
slug: "openclaw-team-skill-upgrade-2-months"
date: 2026-03-14
lastmod: 2026-04-17
author: "成诺"
categories: [AI实战]
...
- [如何给 AI 建立一个灵魂](/posts/how-to-give-ai-a-soul/) — 一切的起点：4个文件搭出AI的三观、性格、记忆和关系
- [结构化输出：省掉70%的人工整理时间](/posts/structured-output-save-70-percent-time/) — Agent之间怎么高效传数据？用JSON替代自然语言
- [我让 AI「审判」了上个月的账单](/posts/ai-roast-my-monthly-bills/) — AI不只能干正经活，还能用毒舌帮你改掉坏习惯

---

团队跑起来之后，内容产量上去了，顺手用 [AI Detector](https://aidetector.life) 检查一下——免费、无需注册，看哪些段落 AI 味过重。

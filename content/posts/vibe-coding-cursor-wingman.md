...
Cursor 直接给了技术方案：Next.js 前端 + FastAPI 后端 + OpenAI Vision API 做截图识别。
...
- OpenAI Vision 识别中文截图偶尔出错 → 换成先用本地 OCR 提取文字，再喂给 GPT
...
| 环节 | 工具 |
|------|------|
| 代码编写 | Cursor (Claude 3.7 Sonnet) |
| 前端框架 | Next.js + Tailwind |
| 后端 | FastAPI (Python) |
| AI 能力 | OpenAI GPT-4o + Vision |

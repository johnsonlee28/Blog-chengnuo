...
- [如何给 AI 建立一个灵魂](/posts/如何给ai建立一个灵魂/) — AI能开你的电脑，但还得有灵魂才知道该干什么
- [OpenClaw团队有岗位没手艺？用了2个月的升级方案](/posts/openclaw团队有岗位没手艺用了2个月的升级方案/) — 远程控制是基础设施，团队协作才是核心
- [结构化输出：省掉70%的人工整理时间](/posts/结构化输出省70后处理时间/) — AI开了电脑之后，怎么让它自动处理抓到的数据
